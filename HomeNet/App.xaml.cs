...
using HomeNetPresentation.ViewModels;         // Твои новые очищенные ВьюМодели
using HomeNetServices.Diagnostics.Logging;
    ...
    public partial class App : Application
    {
        ...
        protected override async void OnStartup(StartupEventArgs e)
        {
            ...
            try
            {
                ...
                // 🔥 Форсируем локальный запуск на SQLite, который мы только что успешно протестировали! 🧼🛸
